...
class DatabaseConnection:
    ...
    def seed_defaults(self) -> None:
        ...
        print("Seeding onboarding task templates...")
        try:
            templates = [
                {
            ...
            print("✓ Onboarding task templates seeded")
        except Exception as exc:
            print(f"✗ Failed to seed onboarding task templates: {exc}")
            raise

        print("Seeding cohort task templates...")
        try:
            ...
            print("✓ Cohort task templates seeded")
        except Exception as exc:
            print(f"✗ Failed to seed cohort task templates: {exc}")
            raise
        ...
        try:
            ...
            for name, slug, desc, active in templates:
                ...
                if not existing:
                    self.execute_dml("""
                        INSERT INTO SURVEY_TEMPLATES (NAME, SLUG, DESCRIPTION, ACTIVE)
                        VALUES (:name, :slug, :desc, :active)
                    """, {"name": name, "slug": slug, "desc": desc, "active": active})
    ...
    def initialize_schema(self) -> bool:
        ...
        try:
            ...
            print("✓ Onboarding tasks seeded")
        except Exception as exc:
            print(f"✗ Onboarding tasks seeding failed: {exc}")
            return False
    ...
    def reset_data(self) -> bool:
        ...
        try:
            ...
            truncate_statements = [
                ...
                "TRUNCATE TABLE COHORT_TASK_TEMPLATES",
                "TRUNCATE TABLE ONBOARDING_TASK_TEMPLATES",
