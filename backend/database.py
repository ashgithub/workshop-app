...
class DatabaseConnection:
    ...
    def seed_defaults(self) -> None:
        ...
        onboarding_questions = [
            {
                "code": "tenancy_access",
                "prompt": "Have you accessed your OCI tenancy?",
                "order": 1,
                "required": "Y",
                "question_type": "choice",
            ...
            {
                "code": "install_vscode",
                "prompt": "Have you installed VS Code?",
                "order": 3,
                "required": "Y",
                "question_type": "choice",
                "config": '{"options":[{"value":"Y","label":"Yes"},{"value":"N","label":"No"}]}',
            ...
            {
                "code": "install_aider",
                "prompt": "Have you installed Aider?",
                "order": 5,
                "required": "Y",
                "question_type": "choice",
                "config": '{"options":[{"value":"Y","label":"Yes"},{"value":"N","label":"No"}]}',
            ...
            {
                "code": "install_sqlcl",
                "prompt": "Have you installed SQLcl?",
                "order": 6,
                "required": "Y",
                "question_type": "choice",
                "config": '{"options":[{"value":"Y","label":"Yes"},{"value":"N","label":"No"}]}',
            ...
            {
                "code": "setup_oci",
                "prompt": "Have you set up your OCI configuration?",
                "order": 7,
                "required": "Y",
                "question_type": "choice",
                "config": '{"options":[{"value":"Y","label":"Yes"},{"value":"N","label":"No"}]}',
            ...
            {
                "code": "clone_repo",
                "prompt": "Have you cloned the workshop repository?",
                "order": 8,
                "required": "Y",
                "question_type": "choice",
                "config": '{"options":[{"value":"Y","label":"Yes"},{"value":"N","label":"No"}]}',
            ...
            {
                "code": "uv_sync",
                "prompt": "Have you run 'uv sync' in the project?",
                "order": 9,
                "required": "Y",
                "question_type": "choice",
                "config": '{"options":[{"value":"Y","label":"Yes"},{"value":"N","label":"No"}]}',
            ...
            {
                "code": "setup_env",
                "prompt": "Have you set up your environment variables?",
                "order": 10,
                "required": "Y",
                "question_type": "choice",
                "config": '{"options":[{"value":"Y","label":"Yes"},{"value":"N","label":"No"}]}',
